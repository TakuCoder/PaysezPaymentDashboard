...
let AddMerchantComponent = class AddMerchantComponent {
...
let MerchantListComponent = class MerchantListComponent {
    constructor(service) {
...
let MerchantStatusComponent = class MerchantStatusComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let TerminalListComponent = class TerminalListComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let TerminalStatusComponent = class TerminalStatusComponent {
    constructor() { }
    ngOnInit() {
    }
};
