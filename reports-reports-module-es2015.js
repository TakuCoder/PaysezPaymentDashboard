...
let LogReportComponent = class LogReportComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let MerchantReportComponent = class MerchantReportComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let TransactionReportComponent = class TransactionReportComponent {
    constructor() { }
    ngOnInit() {
    }
};
